...
var action = function () {
	...
	(0, _createClass3.default)(action, [{
		...
		key: 'getEventValue',
		value: function getEventValue(path, property) {
		...
		value: function updateMeta(meta, path, rowIndex, vars) {
			...
			(0, _keys2.default)(meta).forEach(function (key) {
				if (_this2.event && _this2.event[path] && _this2.event[path][key]) {
					meta[key] = _this2.event[path][key]({ path: path, rowIndex: rowIndex, vars: vars });
				}
