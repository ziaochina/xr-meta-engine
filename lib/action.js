...
var _initialiseProps = function _initialiseProps() {
	...
	this.toast = function (option) {
		...
		if (!option.type) Toast.info.apply(Toast, (0, _toConsumableArray3.default)(option));

		Toast[option.type].apply(Toast, (0, _toConsumableArray3.default)(option));
	};

	this.notification = function (option) {
		var Notification = _config2.default.getNotification();
		if (!Notification) return;

		if (!option.type) Notification.open.apply(Notification, (0, _toConsumableArray3.default)(option));

		Notification[option.type].apply(Notification, (0, _toConsumableArray3.default)(option));
	};
	...
	this.modal = function (option) {
		...
		if (!option.type) Modal.show.apply(Modal, (0, _toConsumableArray3.default)(option));

		Modal[option.type].apply(Modal, (0, _toConsumableArray3.default)(option));
	};
