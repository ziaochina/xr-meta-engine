...
function metaToComponent(meta, props) {
    if ((typeof meta === 'undefined' ? 'undefined' : (0, _typeof3.default)(meta)) == 'object' && meta.prototype && meta.prototype.isReactComponent) {
        return meta;
    } else if ((typeof meta === 'undefined' ? 'undefined' : (0, _typeof3.default)(meta)) == 'object' && !meta.prototype.isReactComponent) {
