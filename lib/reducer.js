...
var reducer = function () {
	...
	(0, _createClass3.default)(reducer, [{
		key: 'initView',
		value: function initView(state, option) {
			var _option$meta = option.meta,
			    ...
			    event = option.event,
			    forView = option.forView;


			return this.initViewByImmutable(state, {
				meta: _immutable2.default.fromJS(meta),
				data: _immutable2.default.fromJS(data),
				event: _immutable2.default.fromJS(event),
				forView: forView
			});
		}
	}, {
		key: 'initViewByImmutable',
		value: function initViewByImmutable(state, option) {
			...
			//设置状态
			);return state.set('meta', meta).set('data', data).set('event', event).set('forView', forView).set('parsedMeta', util.parseMeta(meta));
		}
	}, {
		key: 'onEvent',
...
function actionCreator() {
	...
	return {
		initView: o.initView,
		initViewByImmutable: o.initViewByImmutable,
		getter: util.getter,
